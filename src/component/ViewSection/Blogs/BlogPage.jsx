        ...
        <div className="view_details_left_main">
                ...
                <div className="sale_live_icon">
                  ...
                  <div className="heartbtnholder">
                    ...
                    <div className="sale_live_button">
                      ...
                      >
                        <GoArrowRight size={"14px"} color="rgb(18 185 129)" />
                        sale live
                      </button>
                    </div>
                  </div>
          ...
          <div className="para">
            <p>
              ...
              𝐀𝐢𝐦𝐢𝐧𝐠 𝐭𝐨 𝐛𝐞 𝐭𝐡𝐞 𝐧𝐞𝐱𝐭 𝐭𝐨𝐩 𝐦𝐞𝐦𝐞 𝐭𝐨𝐤𝐞𝐧! 👑𝐒𝐜𝐡𝐮𝐥𝐭𝐳 𝐜𝐫𝐞𝐚𝐭𝐞𝐝 𝐭𝐡𝐞 𝐢𝐦𝐚𝐠𝐞
              𝐨𝐟 𝐒𝐧𝐨𝐨𝐩𝐲 𝐨𝐧 𝐭𝐡𝐞 𝐦𝐨𝐨𝐧, 𝐍𝐀𝐒𝐀 𝐚𝐥𝐬𝐨 𝐦𝐚𝐝𝐞 𝐒𝐧𝐨𝐨𝐩𝐲 𝐚𝐧 𝐚𝐦𝐛𝐚𝐬𝐬𝐚𝐝𝐨𝐫,🌈
              𝐞𝐯𝐞𝐫𝐲𝐭𝐡𝐢𝐧𝐠 𝐢𝐬 𝐡𝐞𝐥𝐩𝐢𝐧𝐠 𝐭𝐨 𝐩𝐮𝐬𝐡 𝐒𝐧𝐨𝐨𝐩𝐲 𝐭𝐨 𝐭𝐡𝐞 𝐦𝐨𝐨𝐧!🌕
            </p>
          </div>
          <div className="address_details">
            <table>
              <tr>
                ...
                <td>
                  <a href="javascript:void(0)">
                    0x9541B7BfA98bb0aEbc0a9D68A08A5e9fBfC957Ae
                  </a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Listing On</td>
                <td>
                  <a href="javascript:void(0)">Pancakeswap</a>
                </td>
              </tr>
              <tr>
